...
<footer class="page-footer font-small unique-color-dark">
    ...
    <div class="container">
      ...
      <div class="row py-4 d-flex align-items-center">
        ...
        <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
          <h5 class="mb-0" align="right">Get connected with us on social networks!</h5>
        </div>
        <!-- Grid column -->
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
        ...
        <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
        <p>
          <i class="fas fa-home mr-3"></i> Pune , Maharashtra , India</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> potsutra@gmail.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> +91-9552879195</p>
        <p>
          <i class="fas fa-print mr-3"></i> +91-7350041234</p>
  ...
  <div class="footer-copyright text-center py-3">© 2018 Copyright:
    <a href="https://mdbootstrap.com/education/bootstrap/"> potsutra@gmail.com</a>
  </div>
  <!-- Copyright -->
